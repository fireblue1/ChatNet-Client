...
const styledExpressions = require('./styledExpressions'); // accesses .json file
...
const checkUserName = /^\w{3,10}$/; // Checks if username is between 3-10 alphanumeric characters
...
const getUser = new Promise((resolve, reject) => {
  term.blue().bold('### Welcome to GAB ChatNet v1.1.0 ###\n');
  term.defaultColor();
  prompt.start();
